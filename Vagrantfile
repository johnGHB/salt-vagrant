...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "master" do |master|
    ...
    master.vm.synced_folder "AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/jnguyen/vagrant/salt", "/vagrant", type: "virtualbox", nfs: true
